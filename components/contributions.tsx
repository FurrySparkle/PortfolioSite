...
const Contributions: NextPage = () => {
  return (
    <div className="self-stretch overflow-hidden flex flex-col py-[27px] px-4 items-center justify-start gap-[36px]">
     ...
     W
      <video  height="500" width="75%" controls typeof="video/ogv"><source src="https://github.com/FurrySparkle/PortfolioSite/blob/main/public/WebDemo.ogv" type="video/ogv"></source></video>
